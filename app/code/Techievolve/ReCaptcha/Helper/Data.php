<?php
	...
	namespace Techievolve\ReCaptcha\Helper;
	...
	class Data extends \Magento\Framework\App\Helper\AbstractHelper
	{
		...
		const CAPTCHA_FORMS = 'reCaptcha/settings/forms';
		 ...
		 * @return string
		 */
		public function getCaptchaForms()
		{
			return $this->getStoreConfig(self::CAPTCHA_FORMS);
		}
		
		
		/*
		* Check if recaptcha enable for contact form
		* @return boolean
		*/
	   
		public function isAllowed($formName){
			$allowedForms = $this->getCaptchaForms();
